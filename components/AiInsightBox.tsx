...
export const AiInsightBox: React.FC<AiInsightBoxProps> = ({ slideTitle, slideData }) => {
    ...
    <div className="mt-6 bg-indigo-950/30 border border-indigo-500/30 rounded-xl p-5">
      ...
      {loading ? (
        <div className="flex items-center gap-2 text-slate-400 text-sm italic">
          ...
          Аналізуємо ринкові дані та сценарії...
        </div>
      ) : insight ? (
        ...
        <div className="text-slate-500 text-xs italic">
          Натисніть кнопку, щоб згенерувати аналіз для цього слайда.
        </div>
      )}
    </div>
  );
